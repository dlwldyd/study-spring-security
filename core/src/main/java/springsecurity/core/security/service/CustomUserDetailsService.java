...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        Account findAccount = userRepository.findAccountAndRoleByUsername(username);
...
//        roles.add(new SimpleGrantedAuthority(findAccount.getRole()));
        ...
        List<GrantedAuthority> collect = findAccount.getUserRoles().stream()
         ...
         */
        return new AccountContext(findAccount, collect);
    }
}
